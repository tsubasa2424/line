...
def add_currency():
    ...
    message = f"{CURRENCY_NAMES.get(symbol, symbol)} の現在の価格は {current_price} 円です。"
    return render_template("index.html", currencies=CURRENCY_NAMES, watchlist=watchlist, message=f"通貨を追加しました！現在の価格: {message}")
