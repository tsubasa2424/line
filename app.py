...
# LINE Notify トークン（ご自身のLINE Notifyアクセストークンを設定してください）
LINE_NOTIFY_TOKEN = "KE1fKLRCwuFx0cIS91mZqivGh20fcEyMtoGWdhuLA5G"  # トークンをここに設定
...
def set_alert():
    ...
    # 通貨名が正しいか確認
    if pair not in CURRENCY_NAMES:
        return jsonify({"error": "サポートされていない通貨ペア"}), 400
